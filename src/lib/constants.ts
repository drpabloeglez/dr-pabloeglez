import heroSrc from '@/assets/images/pablo-eglez-pictures/hero/HeroImage.png'
import heroMobileSrc from '@/assets/images/pablo-eglez-pictures/hero/HeroImageMobile.png'
...
export const SITE_URL = 'https://ginecologiamendoza.com.ar'
